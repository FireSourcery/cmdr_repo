...
//   const VarEventBuilder({super.key, required this.varController, required this.eventBuilder, required this.child});
...
class VarKeyEventBuilder extends StatelessWidget {
  const VarKeyEventBuilder({super.key, required this.varKey, required this.eventBuilder, required this.child});
