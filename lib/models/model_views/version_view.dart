...
/// todo as Map
/// Editable views
// class VersionFormFieldChars<T extends Enum> extends StatelessWidget {
...
//   @override
//   Widget build(BuildContext context) {
//     // return MapFormFields<T, int>.digits(
//     //   entries: version.pairs,
//     //   onSaved: onSaved,
//     //   keyStringifier: (key) => key.name.pascalCase,
//     // );
