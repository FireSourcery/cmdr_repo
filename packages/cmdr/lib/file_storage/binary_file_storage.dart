...
abstract mixin class FirmwareFileStorage implements FileStorage<Map<int, Uint8List>> {
  ...
  @override
  Object? parseContents(Map<int, Uint8List> contents) => contentsBuffer = contents;
  @override
  Map<int, Uint8List> buildContents();
...
class HexFileStorage extends FileStorage<Map<int, Uint8List>> with FirmwareFileStorage {
  ...
  @override
  Map<int, Uint8List> buildContents() => throw UnimplementedError();
}
